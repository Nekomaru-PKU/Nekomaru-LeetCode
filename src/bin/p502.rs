mod solution {
    pub fn main(k: i32, w: i32, profits: Vec<i32>, capital: Vec<i32>) -> i32 {
...
fn main() {
    ...
    assert_eq!(solution::main(2, 0, vec![1, 2, 3], vec![0, 1, 1]), 4);
    assert_eq!(solution::main(3, 0, vec![1, 2, 3], vec![0, 1, 2]), 6);

    // edge case: not enough capital for k projects
    assert_eq!(solution::main(2, 0, vec![1, 2, 3], vec![1, 1, 1]), 0);
}

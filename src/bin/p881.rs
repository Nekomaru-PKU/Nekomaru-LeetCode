fn solution(mut people: Vec<i32>, limit: i32) -> i32 {
...
fn main() {
    ...
    assert_eq!(solution(vec![3, 2, 2, 1], 3), 3);
    assert_eq!(solution(vec![3, 5, 3, 4], 5), 4);

    assert_eq!(solution(vec![5, 1, 7, 4, 2, 4], 7), 4);

    assert_eq!(solution(vec![5, 5, 5, 5, 5], 5), 5);
